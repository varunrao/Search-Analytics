...
/**
 * <b>NOTE:</b> This forked implementation is only here temporarily, in order to facilitate further development of the
 * HBaseMapReduceIndexerTool. If/when the core MapReduceIndexerTool is updated to provide a testing jar, this class should
 * be removed.
 */
